...
To learn how to set up a real time action combat system, follow this tutorial series:
http://orkframework.com/guide/tutorials/3d-action-rpg/start-3d-action-rpg/
